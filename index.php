...
elseif (!$isFromFacebook) {
    header('Location: https://www.facebook.com/mobil1/app_450533221722265');
    die();
}
                ...
                <link rel="stylesheet" type="text/css" href="css/shame.css">
                    <link rel="stylesheet" type="text/css" href="css/fonts.css">
                        <link rel="stylesheet" type="text/css" href="css/icons.css">
                            ...
                            <script>
                                var _gaq = _gaq || [];
                                _gaq.push(['_setAccount', 'UA-56930001-1']);
                                ...
                                $(document).ready(function () {
                                    $("form").validate({
                                        ...
                                        submitHandler: function () {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (returndata) {
                                                    if (returndata.success === true) {
                                                        ...
                                                        $("#submited-story-pic").append("<img src='" + returndata.image + "' >");
                                            ...
                                            ga('send', 'event', 'submit web', 'CLICK');
                                        }
                                    });

                                    $('.js-preview-submit').bind('click', function () {
                                        ga('send', 'event', 'submit preview web', 'CLICK');
                                        var formData = new FormData($("form")[0]);
                                        $.ajax({
                                            url: '<?php echo BASE_URL ?>stories/new/create',
                                            type: 'POST',
                            ...
                            <script>
                                function share_caption(picture, userId, story) {
                                    ga('send', 'event', 'share story web', 'CLICK');
                                    FB.ui({
                                        method: 'feed',
                                ...
                                <main class="restricted">
                                    <section class="top-area">
                                        ...
                                        <div class="landing-intro top-module">
                                            <div class="landing-stories-wrap sg noselect">
                                                <div class="arrow-btn sg-prev">
                                                    <span class=" icon-arrow-left"></span>
                                                </div><ul class="landing-stories sg-content">
                                                    <?php $count = 1; ?>
                                                    ...
                                                    <? endforeach; ?> 
                                                </ul><div class="arrow-btn sg-next noselect">
                                                    <span class="icon-arrow-right"></span>
                                                </div>
                                            </div><div class="landing-msg">
                                                                        ...
                                                                        <div class="preview-submission">
                                                                            <div class="center-container">
                                                                                <div class="story-preview story-box">
                                                                                    ...
                                                                                    <div class="pic">
                                                                                        <!-- submitted story pic-->
                                                                                        <img src='https://performancestory.fb-mobil1.com/cms/web/uploads/default.jpg'  id='imagePreview' />
                                                                                    </div>
                                                                                ...
                                                                                <div class="media-section--content">
                                                                                    ...
                                                                                    <div class="scroll-visible-area">
                                                                                        ...
                                                                                        <div class="overlayed-image-gallery linked-container overlay sg">
                                                                                            ...
                                                                                            <div class="arrow-btn small sg-next noselect">
                                                                                                <span class="icon-arrow-right"></span>
                                                                                            </div>
